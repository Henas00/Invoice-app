    ...
    <div className={styles.container}>
      {modalOpen && <Delete invoice={invoice}/>}
        ...
        <div className={styles.button}>
          {invoice.status !== "paid" && <Buttons handleClick={openEditForm} type="button" text="Edit" btnStyle="btnQuaternary" />}
        ...
        <div className={styles.data}>
          ...
          <div className={styles.body}>
            ...
            <div className={styles.sendTo}>
              <h4>Send To</h4>
            <p><a href={`mailto:${invoice.clientEmail}`}>{invoice.clientEmail}</a></p>
            </div>
          </div>
